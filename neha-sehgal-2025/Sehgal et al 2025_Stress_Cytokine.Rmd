...
cytokine_stress_covars <- cytokine_stress_covars %>%  mutate(job_employ = case_when(job.strain == "1" & employed == "Employed" ~ "Employed and Job Strain", 
                                                                                    job.strain == "1" & employed == "Unemployed" ~ "Unemployed and Job Strain",
                                                                                    job.strain == "0" & employed == "Employed" ~ "Employed and No Job Strain", 
                                                                                    job.strain == "0" & employed == "Unemployed" ~ "Unemployed and No Job Strain",
                                                                                    is.na(job.strain) == TRUE & employed == "Unemployed" ~ "Unemployed and No Job Strain"))
...
plot_correlation(cytokine_stress_covars[,c(2:61, 144)], cor_args = list("use" = "pairwise.complete.obs"))
